  ...
  OK_cam_stations <- read.csv("./Data/OK_Camera_Stations_18-19.csv")
  cam_stations <- read.csv("./Data/NE_Camera_Stations_18-19.csv")
  #  Classified images from camera traps- this takes a few seconds
  OK_megadata <- read.csv("./Data/MegaData_Cameras_summer18_091919.csv")
  megadata <- read.csv("./Data/MegaData_Cameras_summer18_NE_partial.csv")
  ...
  images <- megadata %>%
    ...
    #  Break CameraLocation into two columns
  ...
  #  Filter dates to specific range (06/13/2018 - 09/30/2018)
  #  Using 6/13 instead of 6/1 to match date range of OK cameras
  ...
  #  How many images do we have from day 1?
  which(images_summer18$Date == "2018-06-01")
  which(images_summer18$Date == "2018-06-13")
  ...
  write.csv(stations, "./Data/NE_cam_stations.csv")
